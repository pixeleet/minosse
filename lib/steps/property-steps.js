...
module.exports = function propertySteps() {
    ...
    this.Given(/^I check (?:property|the) (.+?) (equals|does not equals) (.+)$/,
        ...
        this._log.info('Step: I check property %s does not equals or equals %s', propertyString, valueString);
     ...
     */
    this.Given(/^I check (?:property|the) (.+) has format (.+)$/,
               function(propertyString, format, done) {
        this._log.info('Step: I check property %s has format %s', propertyString, format);
